                ...
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body card-thumbnail">
                            <img src="{{ asset('modules/landing-pages/images/blog-detail/01.webp') }}" alt=""
                                class="img-fluid rounded object-cover iq-blog-experience mt-3 mb-3 w-100"
                                loading="lazy">

                            <span class="text-primary sub-title mt-2">02 Dec 2021</span>
                            <div class="d-flex gap-3 mt-3">
                                <a href="../blog/blog-detail.html" class="iq-blog-adventure fs-6">Travel</a><span> |
                                </span>
                                <a href="../blog/blog-detail.html" class="iq-blog-adventure text-primary fs-6">Jenny
                                    Wilson</a>
                            </div>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Neque at velit ultrices
                                convallis. Purus sed adipiscing hendrerit risus id dapibus tristique consectetur. Enim
                                non viverra massa sollicitudin arcu aliquam, sagittis aliquet diam.</p>
                            <h6 class="mt-3 mb-0">Through the States</h6>
                            <p class="mt-3">Lorem ipsum dolor sit amet, <span class="text-primary">consectetur</span>
                                adipiscing elit. Neque at velit ultrices convallis. Purus sed adipiscing hendrerit risus
                                id dapibus tristique consectetur. Enim non viverra massa sollicitudin arcu aliquam,
                                sagittis aliquet diam.</p>
                            ...
                            <p class="mt-3">Lorem ipsum dolor sit amet, <span class="text-primary">consectetur
                                    adipiscing elit.</span> Neque at velit ultrices convallis set. Purus sed adipiscing
                                hendrerit risus id dapibus tristique consectetur enim non viverra.</p>
                            <p class="mt-3 mb-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Neque at velit
                                ultrices convallis set. Purus sed adipiscing hendrerit risus id dapibus tristique
                                consectetur enim non viverra.</p>
                                    ...
                                    <div class="d-flex flex-sm-nowrap flex-wrap justify-content-center gap-3">
                                        <div>
                                            <img class="img-fluid object-contain avatar-120 rounded-0"
                                                src="{{ asset('/modules/blog/images/blog-avatar/07.png') }}"
                                                alt="01" loading="lazy">
                                        </div>
                                        <div>
                            ...
                            <div class="card shadow-none bg-transparent border ms-5">
                                <div class="card-body">
                                    <div class="d-flex flex-sm-nowrap flex-wrap justify-content-center gap-3">
                                        <div>
                                            <img class="img-fluid object-contain avatar-120 rounded-0"
                                                src="{{ asset('/modules/blog/images/blog-avatar/08.png') }}" alt="01"
                                                loading="lazy">
                                        </div>
                                        <div>
                                            <div class="d-flex justify-content-between align-items-center my-2 my-lg-0">
                            ...
                            <div class="card shadow-none bg-transparent border mb-0">
                                <div class="card-body">
                                    <div class="d-flex flex-sm-nowrap flex-wrap justify-content-center gap-3">
                                        <div>
                                            <img class="img-fluid object-contain avatar-120 rounded-0"
                                                src="{{ asset('/modules/blog/images/blog-avatar/07.png') }}" alt="01"
                                                loading="lazy">
                                        </div>
                                        <div>
                                            <div
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 d-flex justify-content-between">
                                        <div class="form-check mb-3">
                                            ...
                                            <label class="form-check-label" for="customCheck1">Save my name and email
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="mt-3">Elit vitae neque velit mattis elementum egestas non, Sem eget.
                                    </p>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <img class="img-fluid fit-img mb-4 object-cover iq-recent-post w-100"
                                src="../blog/assets/images/blog-detail/05.png" alt="01" loading="lazy">
                            <small class="text-primary sub-title mb-3">April 19th 2021</small>
                            <a href="../blog/blog-detail.html" class="iq-title">
                                <h6 class="mt-2 mb-3">5 Beauty Essentials Everyone Should Have in Their Collection.
                                </h6>
                            </a>
                            ...
                            <p class="pt-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam ut eu
                                morbi tincidunt </p>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-grid gap-3 grid-cols-2">
                                <a href="#">
                                    <svg width="6" viewBox="0 0 5 6" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
