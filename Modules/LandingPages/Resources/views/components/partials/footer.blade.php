        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    ...
                    <p class="mb-5 mt-4">It is a long established fact that a reader will be distracted by the
                ...
                <div class="col-md-4 mt-md-0 mt-4">
                    ...
                    <h5 class="mt-5 text-white">Social</h5>
                    <ul class="list-unstyled p-0 m-0 d-flex mt-4 social-icon">
                        <li>
                            <a href="#"><svg width="30" height="30" viewBox="0 0 30 30"
                                    fill="none">
                                    <path
