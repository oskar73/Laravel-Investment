        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-xl-6">
                    <p class="mb-2 text-uppercase text-primary sub-title">
                        faq
                    </p>
                    <h2 class="text-secondary mb-4 mb-lg-5">Foremost Common <span class="text-primary">Questions</span>
                    </h2>
                    ...
                    <div class="accordion custom-accordion faq" id="accordionExample">
                        <div class="accordion-item mb-4 pb-2 border-bottom rounded-0">
                            <div class="accordion-header" id="headingOne">
                                <button class="accordion-button px-0 h5 pt-0 mb-0" type="button"
                        ...
                        <div class="accordion-item mb-4 pb-2 border-bottom rounded-0">
                            <div class="accordion-header" id="headingTwo">
                                <button class="accordion-button collapsed px-0 h5 mb-0" type="button"
                        ...
                        <div class="accordion-item mb-4 pb-2 border-bottom rounded-0">
                            <div class="accordion-header" id="headingThree">
                                <button class="accordion-button collapsed h5 px-0 mb-0" type="button"
