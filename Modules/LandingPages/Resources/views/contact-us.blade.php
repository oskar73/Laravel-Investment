<x-app-layout layout="landing" :isHeader1=true>
                        ...
                        <div class="card-body text-center">
                            <div class="services  rounded-pill text-center mx-auto mb-4">
                                <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="map-marker-alt"
                                    ...
                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" width="32"
                                    height="32">
                        ...
                        <div class="card-body text-center">
                            <div class="services rounded-pill text-center mx-auto mb-4">
                                <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="envelope"
                                    class="svg-inline--fa fa-envelope fa-w-16 text-primary"
                        ...
                        <div class="card-body text-center">
                            <div class="services rounded-pill text-center mx-auto mb-4">
                                <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="phone-alt"
                                    class="ssvg-inline--fa fa-phone-alt fa-w-16 text-primary"
                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="32"
                                    height="32">
                                    <path fill="currentColor"
    ...
    <div class="section-padding bg-secondary">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <p class="mb-2 text-uppercase text-white sub-title">
                        Contact Us
                    </p>
                    <h2 class="text-white mb-5 pb-2">
                        Have any query?
                        <br>
