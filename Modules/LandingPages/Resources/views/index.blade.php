        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-7 banner-one-img text-center ms-2 ms-sm-0">
                    <img src="{{ asset('modules/landing-pages/images/home-1/banner-top.webp') }}" alt="01"
                        alt="01" class="img-fluid ">
                </div>
                <div class="col-lg-5 inner-box">
                    <div class="mb-2 text-uppercase text-primary sub-title">
                        Look fit, feel fit
                    </div>
                    <h1 class="text-secondary mb-lg-5 mb-4 text-capitalize">The Joy Of<br><span
                            class="text-primary">Right Health</span></h1>
                    <p class="mb-lg-5 mb-4">It is a long established fact that a reader will be distracted by the
                        readable content of a page when looking at its layout. </p>
                    <div class="d-flex align-items-center store-btn pt-2">
                        <a href="https://hopeui.iqonic.design/" class="btn btn-primary">Download Free</a>
                        <a href="https://iqonic.design/product/templates/hope-ui-pro-unlimited/"
                            class="btn btn-secondary ms-4">Buy Pro</a>
                    </div>
                    <div class="star-box mt-4">
                        <div class="d-flex mb-2  align-items-center">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <svg class="ms-1" xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                        ...
                                        <path
                                            ...
                                            fill="#D9D9D9"></path>
                                        <mask id="mask0_1182_914" style="mask-type:alpha" maskUnits="userSpaceOnUse"
                                            x="2" y="1" width="17" height="16">
                                            <path
                                                d="M9.65623 2.03398C9.80257 1.58357 10.4398 1.58358 10.5861 2.03398L12.1443 6.82956C12.2097 7.03099 12.3974 7.16737 12.6092 7.16737H17.6516C18.1252 7.16737 18.3221 7.77338 17.939 8.05174L13.8596 11.0156C13.6883 11.1401 13.6166 11.3607 13.682 11.5622L15.2402 16.3577C15.3865 16.8081 14.871 17.1827 14.4879 16.9043L10.4085 13.9405C10.2372 13.816 10.0052 13.816 9.83382 13.9405L5.75445 16.9043C5.37131 17.1827 4.85581 16.8081 5.00215 16.3577L6.56033 11.5622C6.62578 11.3607 6.55408 11.1401 6.38274 11.0156L2.30337 8.05174C1.92024 7.77338 2.11714 7.16737 2.59072 7.16737H7.6331C7.84489 7.16737 8.0326 7.03099 8.09805 6.82956L9.65623 2.03398Z"
                                                fill="#F2B827"></path>
                                        </mask>
                            ...
                            <img src="{{ asset('modules/landing-pages/images/home-1/13.webp') }}" alt="02"
    ...
    <div class="bg-secondary features-card">
        <div class="container">
            <div class="row mx-2 mx-sm-0">
                ...
                <div class="col-lg-6 top-feature">
                    <div class="text-right">
                        ...
                        <h2 class="mb-5 text-white notch-feature-txt mb-5 text-capitalize">Top Notch Features </h2>
            ...
            <div class="row row-cols-sm-2 row-cols-lg-4">
                <div class="col">
                    <div class="card services-box  rounded-2">
                ...
                <div class="col">
                    <div class="card services-box  rounded-2">
                        <div class="card-body p-0">
                            ...
                            <svg class="text-primary" width="12" height="13" viewBox="0 0 12 13"
    ...
    <div class="section-padding">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <img src="{{ asset('modules/landing-pages/images/home-1/aboutus.webp') }}" alt="3"
                        class="img-fluid ">
                </div>
                <div class="col-md-6">
                    <p class="mb-2 text-primary text-uppercase sub-title">
                        about us
                    </p>
                    <h2 class="text-secondary mb-lg-5 mb-4 text-capitalize">What they say <br> <span
                    ...
                    <div class="d-flex align-items-center mb-lg-5 mb-4 about-icon-box">
                        <div class="p-2 border border-secondary rounded d-flex text-secondary align-items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                ...
                                <path
                                    ...
                                    stroke="#001F4C" stroke-width="1.25" stroke-linecap="round"
                                    stroke-linejoin="round">
                                </path>
                            </svg>
                            <span class="mb-0 ms-1">400+ UI Components</span>
                        </div>
                        <div class="p-2 border border-secondary rounded d-flex text-secondary align-items-center ms-3">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                viewBox="0 0 18 18" fill="none">
                                <path
                                    d="M5.5625 9.00008L7.6875 11.1251L11.9375 6.87508M15.8333 9.00008C15.8333 12.9121 12.662 16.0834 8.75 16.0834C4.83798 16.0834 1.66666 12.9121 1.66666 9.00008C1.66666 5.08806 4.83798 1.91675 8.75 1.91675C12.662 1.91675 15.8333 5.08806 15.8333 9.00008Z"
                    ...
                    <a hrer="javascript" class="btn btn-primary mt-2">Get Started</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-5">
                    ...
                    <h2 class="text-secondary mb-lg-5 mb-4 text-capitalize">Fast, easy, and <br> <span
                            class="text-primary">Affordable</span></h2>
                    <p class="mb-lg-5 mb-4">It is a long establishad fact that a reader will be distracted by the
                        readable
                        content
                        of a page when looking at its layout. </p>
                    <div class="d-flex align-items-center store-btn flex-wrap pt-2">
                        <img src="{{ asset('modules/landing-pages/images/home-1/playstore.webp') }}" alt="04"
                            class="img-fluid">
                        <img src="{{ asset('modules/landing-pages/images/home-1/appstore.webp') }}" alt="05"
                        ...
                        <div class="d-flex mb-2  align-items-center">
                            <div class="border-end pe-2">
                                <div class="d-flex align-items-center">
                                    ...
                                    <svg class="ms-1" xmlns="http://www.w3.org/2000/svg" width="20"
                                        height="20" viewBox="0 0 20 20" fill="none">
                                        <path
                                            d="M9.65623 2.03398C9.80257 1.58357 10.4398 1.58358 10.5861 2.03398L12.1443 6.82956C12.2097 7.03099 12.3974 7.16737 12.6092 7.16737H17.6516C18.1252 7.16737 18.3221 7.77338 17.939 8.05174L13.8596 11.0156C13.6883 11.1401 13.6166 11.3607 13.682 11.5622L15.2402 16.3577C15.3865 16.8081 14.871 17.1827 14.4879 16.9043L10.4085 13.9405C10.2372 13.816 10.0052 13.816 9.83382 13.9405L5.75445 16.9043C5.37131 17.1827 4.85581 16.8081 5.00215 16.3577L6.56033 11.5622C6.62578 11.3607 6.55408 11.1401 6.38274 11.0156L2.30337 8.05174C1.92024 7.77338 2.11714 7.16737 2.59072 7.16737H7.6331C7.84489 7.16737 8.0326 7.03099 8.09805 6.82956L9.65623 2.03398Z"
                                            fill="#D9D9D9"></path>
                                        <mask id="mask0_1182_915" style="mask-type:alpha" maskUnits="userSpaceOnUse"
                                            x="2" y="1" width="17" height="16">
                                            <path
                                                d="M9.65623 2.03398C9.80257 1.58357 10.4398 1.58358 10.5861 2.03398L12.1443 6.82956C12.2097 7.03099 12.3974 7.16737 12.6092 7.16737H17.6516C18.1252 7.16737 18.3221 7.77338 17.939 8.05174L13.8596 11.0156C13.6883 11.1401 13.6166 11.3607 13.682 11.5622L15.2402 16.3577C15.3865 16.8081 14.871 17.1827 14.4879 16.9043L10.4085 13.9405C10.2372 13.816 10.0052 13.816 9.83382 13.9405L5.75445 16.9043C5.37131 17.1827 4.85581 16.8081 5.00215 16.3577L6.56033 11.5622C6.62578 11.3607 6.55408 11.1401 6.38274 11.0156L2.30337 8.05174C1.92024 7.77338 2.11714 7.16737 2.59072 7.16737H7.6331C7.84489 7.16737 8.0326 7.03099 8.09805 6.82956L9.65623 2.03398Z"
                                                fill="#F2B827"></path>
                ...
                <div class="col-lg-7 mt-5 mt-lg-0">
                    <img src="{{ asset('modules/landing-pages/images/home-1/dwn-1.webp') }}" alt="07"
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-4">
                    ...
                    <h2 class="text-secondary mb-lg-5 mb-4 text-capitalize">Our <span class="text-primary">Price<br>
                            Plans</span>
                    </h2>
                    <p class="mb-lg-5 mb-4">It is a long established fact that a reader will be distracted by the
                        readable
                        ...
                        <div class="col iq-star-inserted-3">
                            <div class="card my-5">
                                <div class="card-body page-bg">
                                    ...
                                    <button type="button" class="btn custom-btn btn-white w-100 shadow">Get
                                        Started</button>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12 text-center">
                    ...
                    <h2 class="text-secondary mb-4 mb-lg-5 text-capitalize">Seamless User Experience, Assured!</h2>
                    <p class="mb-4 mb-lg-5 pb-4 pb-lg-5">It is specially designed for any kind of mobile app, software,
                        sass, startup,<br>marketing, one page and other online businesses. </p>
                </div>
            </div>
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-2 col-md-6">
                    <img src="{{ asset('modules/landing-pages/images/home-1/01.webp') }}" alt="10"
                        class="img-fluid d-block mx-auto">
                </div>

                <div class="col-lg-2 col-md-6">
                    <img src="{{ asset('modules/landing-pages/images/home-1/02.webp') }}" alt="11"
                        class="img-fluid d-block mx-auto">
                </div>
                <div class="col-lg-3 col-md-12">
                    <img src="{{ asset('modules/landing-pages/images/home-1/03.webp') }}" alt="12"
                        class="img-fluid d-block mx-auto">
                </div>
                <div class="col-lg-2 col-md-6">
                    <img src="{{ asset('modules/landing-pages/images/home-1/15.webp') }}" alt="13"
                        class="img-fluid d-block mx-auto">
                </div>
                <div class="col-lg-2 col-md-6">
                    <img src="{{ asset('modules/landing-pages/images/home-1/16.webp') }}" alt="14"
                        class="img-fluid d-block mx-auto">
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-12 text-center">
                    ...
                    <h2 class="text-secondary mb-5 text-capitalize">We are a team of dedicated <br><span
            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-2 row-cols-lg-4 pt-5">
                <div class="col">
        ...
        <div class="container">
            <div class="row align-items-center text-center">
                <div class="col-lg-12">
                    ...
                    <h2 class="text-secondary customer-txt mb-5 text-capitalize">What our <span
                            class="text-primary">Customer’s </span>are saying</h2>
                </div>
                <div class="overflow-hidden slider-circle-btn mt-3" id="testimonial-slider">
                    <ul class="p-0 m-0 swiper-wrapper list-inline  ">
                        ...
                        mei."
                                teamImage="14.webp" testOwner="Elsa Schmidt" testSubtitle="Spa" />
                        </li>
                        <li class="swiper-slide">
                            <x-landing-pages.widgets.testiominal
                                testText="Torquatos nec eu, detr
                        ...
                        epicurei mea. Mea facilisis urbanitas.Torquatos nec eu, detr periculis ex, nihil expetendis in
                        mei."
                                teamImage="17.webp" testOwner="Leslie Alexander " testSubtitle="Spa" />
                        </li>
                        <li class="swiper-slide">
                            <x-landing-pages.widgets.testiominal
                                testText="Torquatos nec eu, detr
                        ...
                        epicurei mea. Mea facilisis urbanitas.Torquatos nec eu, detr periculis ex, nihil expetendis in
                        mei."
                                teamImage="18.webp" testOwner="Robert Fox" testSubtitle="Spa" />
                        </li>
                        <li class="swiper-slide">
                            <x-landing-pages.widgets.testiominal
                                testText="Torquatos nec eu, detr
                        ...
                        epicurei mea. Mea facilisis urbanitas.Torquatos nec eu, detr periculis ex, nihil expetendis in
                        mei."
                                teamImage="14.webp" testOwner="Robert Fox" testSubtitle="Spa" />
                        </li>
                    </ul>
                    <div class="swiper-button swiper-button-next"></div>
                    <div class="swiper-button swiper-button-prev"></div>
