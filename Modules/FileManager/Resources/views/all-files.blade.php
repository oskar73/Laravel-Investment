<x-app-layout layout="filemanager" :assets="$assets ?? []" title="All-files" :isSweetalert="true" isUppy="true" isFslightbox="true">
...
<div class="border-bottom pb-3 d-flex align-items-center justify-content-between">
    ...
    <h4 class="py-3 mb-0">Documents</h4>
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4">
            ...
            <div class="col">
                <x-modules.filemanager.document imageDate="Dec 13, 2020" imgName="xyz-25783.pptx" imgLink="2 days ago" imgChange="ppt.svg" imgMb="12mb" docType="XLSX" docName="demo.xlsx"/>
            </div>
        </div>
