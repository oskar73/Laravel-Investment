                ...
                <div class="card-body  card-thumbnail">
                    <div>
                        ...
                        <div class="d-flex gap-3">
                            <a href="{{ route('blog.details') }}" class="iq-blog-adventure fs-6">Travel</a><span> |
                            </span>
                            <a href="{{ route('blog.details') }}" class="iq-blog-adventure text-primary fs-6">Jenny
                                Wilson</a>
                        </div>
                    </div>
                    <img class="img-fluid rounded object-cover iq-blog-experience mt-3 mb-3 w-100"
                        src="{{ asset('modules/blog/images/blog-detail/01.png') }}" alt="01">
                    <h5 class="mt-3 mb-0">Through the States</h5>
                    <p class="mt-3">Lorem ipsum dolor sit amet, <span class="text-primary">consectetur</span>
                        adipiscing elit. Neque at velit ultrices convallis. Purus sed adipiscing hendrerit risus id
                        dapibus tristique consectetur. Enim non viverra massa sollicitudin arcu aliquam, sagittis
                        aliquet diam.</p>
                    ...
                    <p class="mt-3">Lorem ipsum dolor sit amet, <span class="text-primary">consectetur adipiscing
                            elit.</span> Neque at velit ultrices convallis set. Purus sed adipiscing hendrerit risus id
                        dapibus tristique consectetur enim non viverra.</p>
                    <p class="mt-3 mb-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Neque at velit
                        ultrices convallis set. Purus sed adipiscing hendrerit risus id dapibus tristique consectetur
                        enim non viverra.</p>
                            ...
                            <div class="d-flex flex-sm-nowrap flex-wrap justify-content-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="mt-2 mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                        Aliquam ut eu morbi tincidunt erat egestas quisque ultrices ut. Vel elementum
                                        blandit et tellus sit tincidunt.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex flex-sm-nowrap flex-wrap justify-content-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="mt-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam
                                        ut eu morbi tincidunt erat egestas quisque ultrices ut. Vel elementum blandit et
                                        tellus sit tincidunt.</p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="text"id="message" rows="4" class="form-control w-100"
                            ...
                            <div class="col-lg-12 d-flex justify-content-between">
                                <div class="form-check mb-3">
                                    ...
                                    <label class="form-check-label" for="customCheck1">Save my name and email in this
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <img class="img-fluid fit-img mb-4 object-cover iq-recent-post w-100"
                        src="{{ asset('modules/blog/images/blog-detail/05.png') }}" alt="01">
                    <div>
                        <small class="text-primary">April 19th 2021</small>
                        <a href="{{ asset('modules/blog/images/blog-detail') }}" class="iq-title">
                            <h4 class=" mt-2 my-3">5 Beauty Essentials Everyone Should Have in Their Collection.</h4>
                        </a>
