<x-app-layout layout="blog" :assets="$assets ?? []" :isBanner="false" title='Comments List' active="blog-comments">
    ...
    <div class="card">
        <div class="card-body px-0">
            <div class="table-responsive">
                <table class="table table-striped py-3" role="grid" data-table="blog-comment">
                    <thead>
                        <tr>
                            <th>Profiles</th>
                            <th>Comment</th>
