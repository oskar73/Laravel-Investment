                        ...
                        <div class="swiper-container gallery-top text-end">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <img alt="product-15"
                                        src="{{ asset('modules/e-commerce/images/bag-product/10.png') }}" />
                                </div>
                                <div class="swiper-slide">
                                    <img alt="product-16"
                                        src="{{ asset('modules/e-commerce/images/bag-product/20.png') }}" />
                                </div>
                                <div class="swiper-slide">
                                    <img alt="product-17"
                                        src="{{ asset('modules/e-commerce/images/bag-product/30.png') }}" />
                                </div>
                                <div class="swiper-slide">
                                    <img alt="product-17"
                                        src="{{ asset('modules/e-commerce/images/bag-product/40.png') }}" />
                                </div>
                                <div class="swiper-slide">
                                    <img alt="product-17"
                                        src="{{ asset('modules/e-commerce/images/bag-product/50.png') }}" />
                                </div>
                                <div class="swiper-slide">
                                    <img alt="product-17"
                                        src="{{ asset('modules/e-commerce/images/bag-product/60.png') }}" />
                                </div>
                                <div class="swiper-slide">
                                    <img alt="product-17"
                                        src="{{ asset('modules/e-commerce/images/bag-product/90.png') }}" />
                                </div>
                            </div>
                            <div class="swiper-button swiper-button-next"></div>
                            <div class="swiper-button swiper-button-prev"></div>
                            <button class="btn btn-secondary-subtle rounded-circle btn-lg btn-icon"
                                data-bs-toggle="modal" data-bs-target="#product-viewer360">
                                <span class="btn-inner">
                                    <svg class="icon-24" width="24" viewBox="0 0 24 24" fill="none"
                                        ...
                                        <path d="M8.85788 14L11.2777 17.0142L8 19.0636" stroke="currentColor"
                    ...
                    <div class="modal-dialog modal-xl" style="max-width: 1400px;">
                        <div class="modal-content  bg-transparent border-0 shadow-none">
                            <div class="model-header text-end">
                                <button type="button" class="btn btn-light m-2" aria-label="Close"
                                    data-bs-dismiss="modal">{{ __('e-commerce.close') }}</button>
                            </div>
                                    ...
                                    <div class="col-12">
                                        <div class="d-flex flex-column">
                                            <div class="cloudimage-360"
                                                data-folder="{{ asset('modules/e-commerce/images/bag-product/') }}/"
                                                data-filename="{index}.png" data-amount-x="120"
                                                data-hide-360-logo="true" data-pointer-zoom="2"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-lg-5 mt-4 mt-lg-0">
                    <div class="border-bottom">
                            ...
                            <div class="d-flex justify-content-between mb-2">
                                ...
                                <div class="d-flex justify-content-end ">
                                    <button class="btn btn-primary-subtle btn-icon rounded-pill"
                                        ...
                                        data-bs-target="#share-btn" aria-controls="share-btn" role="button">
                                        <span class="btn-inner">
                        ...
                        <div class="d-flex my-4">
                            ...
                            <h4 class="text-primary mb-0 ms-2">$45.99</h4>
                        </div>
                    </div>
                    <div class="border-bottom">
                        <p class="py-4 mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Lacus eleifend
                            ultrices vestibulum tempor augue bibendum dolor quam malesuada.consectetur adipiscing elit.
                        </p>
                    </div>
                    <div class="d-flex flex-column py-4">
                        <div class="d-flex align-items-center mb-3">
                            <span class="text-dark">Free Delivery:</span>
                            <span class="text-primary  ms-2">Thursday, April 07</span>
                        </div>
                        <div class="d-flex align-items-center mb-3">
                    ...
                    <div>
                        ...
                        <div class="d-flex py-4 flex-wrap gap-4">
                            <a href="{{ route('e-commerce.order-process') }}"
                                class="btn btn-warning d-flex gap-2 align-items-center">
        ...
        <div class="card-body">
            ...
            <div class="tab-content mt-4" id="nav-tabContent">
                <div class="tab-pane fade show active" id="nav-description" role="tabpanel"
                    ...
                    <div class="d-flex flex-column">
                        <p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Lacus eleifend
                            ultrices vestibulum tempor augue bibendum dolor quam malesuad.Lorem ipsum dolor sit amet,
                            consectetur adipiscing elit. Lacus eleifend ultrices vestibulum tempor augue bibendum dolor
                            quam malesuad.</p>
                        <div class="row row-cols-2 row-cols-lg-5 py-3">
                            <div class="col">
                                <img src="{{ asset('modules/e-commerce/images/bag-product/10.png') }}"
                                    alt="product-details" class="img-fluid iq-product-img rounded-2 w-100 ">
                            </div>
                            <div class="col">
                                <img src="{{ asset('modules/e-commerce/images/bag-product/31.png') }}"
                                    alt="product-details" class="img-fluid iq-product-img rounded-2  w-100 ">
                            </div>
                            <div class="col">
                                <img src="{{ asset('modules/e-commerce/images/bag-product/52.png') }}"
                                    alt="product-details" class="img-fluid iq-product-img rounded-2 w-100  ">
                            </div>
                            <div class="col">
                                <img src="{{ asset('modules/e-commerce/images/bag-product/83.png') }}"
                                    alt="product-details" class="img-fluid iq-product-img rounded-2  w-100 ">
                            </div>
                            <div class="col">
                                <img src="{{ asset('modules/e-commerce/images/bag-product/103.png') }}"
                                    alt="product-details" class="img-fluid iq-product-img rounded-2  w-100  ">
                            </div>
                        </div>
                        <p class="mb-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Lacus eleifend
                            ultrices vestibulum tempor augue bibendum dolor quam malesuad.Lorem ipsum dolor sit amet,
                            consectetur adipiscing elit. Lacus eleifend ultrices vestibulum tempor augue bibendum dolor
                            quam malesuad.</p>
                        <p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Lacus eleifend
                        ...
                        <div class="card shadow-none bg-transparent border">
                            <div class="card-body">
                                <div class="d-flex flex-sm-nowrap flex-wrap">
                                    <div>
                                        <img class="img-fluid object-contain avatar-120 rounded"
                                            src="{{ asset('modules/e-commerce/images/user/04.png') }}"
                                            alt="01">
                                    </div>
                        ...
                        <div class="card shadow-none bg-transparent border">
                            <div class="card-body">
                                <div class="d-flex flex-sm-nowrap flex-wrap">
                                    <div>
                                        <img class="img-fluid object-contain avatar-120 rounded"
                                            src="{{ asset('modules/e-commerce/images/user/01.png') }}"
                                            alt="01">
                                    </div>
                                    <div class="ms-0 ms-sm-3">
                                        <div class="d-flex justify-content-between align-items-center my-2 my-lg-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 d-flex justify-content-between">
                                <div class="form-check mb-3">
                                    ...
                                    <label class="form-check-label" for="customCheck1">Save my name, email, and
        ...
        <div class="overflow-hidden position-relative ecommerce-slider slider-circle-btn" id="ecommerce-slider">
            <ul class="p-0 m-0 mb-2 swiper-wrapper list-inline">
                <li class="swiper-slide card-slide">
                    <div class="col">
                        <x-modules.e-commerce.widgets.product-card slidercard="mb-0"
                            productname="{{ __('e-commerce.shoe') }}" statusdetails="" statuscolor=""
                            productimage="product/06.png" productrating="3.5" productprice="$56.00" />
                    </div>
                </li>
                <li class="swiper-slide card-slide">
                    <div class="col">
                        <x-modules.e-commerce.widgets.product-card slidercard="mb-0"
                            productname="{{ __('e-commerce.pink_triusers') }}" statusdetails="Sold"
                            statuscolor="warning" productimage="product/07.png" productrating="3.5"
                            productprice="$65.00" />
                    </div>
                </li>
                <li class="swiper-slide card-slide">
                    <div class="col">
                        <x-modules.e-commerce.widgets.product-card slidercard=""
                            productname="{{ __('e-commerce.knit_shrug') }}" statusdetails="" statuscolor=""
                            productimage="product/10.png" productrating="3.5" productprice="$56.00" />
                    </div>
                </li>
                <li class="swiper-slide card-slide">
                    <div class="col">
                        <x-modules.e-commerce.widgets.product-card slidercard=""
                            productname="{{ __('e-commerce.pink_hand') }}" statusdetails="" statuscolor=""
                            productimage="product/11.png" productrating="3.5" productprice="$56.00" />
                    </div>
                </li>
                <li class="swiper-slide card-slide">
                    <div class="col">
                        <x-modules.e-commerce.widgets.product-card slidercard=""
                            productname="{{ __('e-commerce.biker’s_jacket') }}" statusdetails="New"
                            statuscolor="primary" productimage="product/04.png" productrating="3.5"
                            productprice="$65.00" />
                    </div>
                </li>
                <li class="swiper-slide card-slide">
                ...
                <li class="swiper-slide card-slide">
                    <div class="col">
                        <x-modules.e-commerce.widgets.product-card slidercard="mb-0"
                            productname="{{ __('e-commerce.blue_hand') }}" statusdetails="" statuscolor=""
                            productimage="product/06.png" productrating="3.5" productprice="$56.00" />
                    </div>
                </li>
            </ul>
