            ...
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pills-grid-view" role="tabpanel" aria-labelledby="grid-view-tab">
                    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3">
                        ...
                        <div class="col">
                            <x-modules.e-commerce.widgets.product-card  slidercard="mb-0" productname="{{__('e-commerce.biker’s_jacket')}}" statusdetails="NEW" statuscolor="primary" productimage="product/04.png" productrating="3.5" productprice="$56.00"/>
                        </div>
                        <div class="col">
