                    ...
                    <div class="col-lg-5 mt-4 mt-lg-0">
                        <div class="border-bottom">
                            ...
                            <div class="d-flex my-4">
                                ...
                                <h4 class="text-primary mb-0 ms-2">$49.99</h4>
                            </div>
                        </div>
                        <div class="border-bottom">
                        ...
                        <div class="d-flex flex-column py-4">
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <span class="text-primary  ms-2">{{__('e-commerce.thurs')}}, March 04</span>
                            </div>
                            <div class="d-flex align-items-center mb-3">
                        ...
                        <div>
                            <div class="btn-group iq-qty-btn mb-3" data-qty="btn" role="group">
                                ...
                                <input type="text" class="btn btn-sm border-light input-display form-control" data-qty="input" value="2" title="Qty" readonly>
