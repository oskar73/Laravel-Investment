<x-app-layout layout="e-commerce" :assets="$assets ?? []" title='User List' isDataTable='true'>

<div class="row">
   <div class="col-lg-12">
       <div class="card">
           <div class="card-header">
                <h4 class="card-title">{{__('e-commerce.user_list')}}</h4>
           </div>
                    ...
                    <table class="table table-striped mb-0" id="datatable" data-toggle="data-table">
                        <thead>
                            <tr >
                                ...
                                <th scope="col" class="text-center">{{__('e-commerce.act')}}</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
