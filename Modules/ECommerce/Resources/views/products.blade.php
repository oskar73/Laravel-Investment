            ...
            <div class="tab-content" id="pills-tabContent">
                ...
                <div class="tab-pane fade show active" id="pills-grid-view" role="tabpanel" aria-labelledby="grid-view-tab">
                    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4">
                        <div class="col">
                            <x-modules.e-commerce.widgets.product-card  slidercard="" productname="{{__('e-commerce.shoe')}}" statusdetails="" statuscolor="" productimage="product/02.png" productrating="3.9" productprice="$56.00"/>
                        </div>
                        <div class="col">
                        ...
                        <div class="col">
                            <x-modules.e-commerce.widgets.product-card  slidercard="" productname="{{__('e-commerce.knit_shrug')}}" statusdetails="" statuscolor="" productimage="product/05.png" productrating="3.5" productprice="$65.00"/>
                        </div>
                        <div class="col">
                            <x-modules.e-commerce.widgets.product-card  slidercard="" productname="{{__('e-commerce.blue_hand')}}" statusdetails="" statuscolor="" productimage="product/06.png" productrating="3.5" productprice="$65.00"/>
                        </div>
                        <div class="col">
                            <x-modules.e-commerce.widgets.product-card  slidercard="" productname="{{__('e-commerce.sweater')}}" statusdetails="Sold" statuscolor="warning" productimage="product/07.png" productrating="3.5" productprice="$65.00"/>
                        </div>
                        <div class="col">
                            <x-modules.e-commerce.widgets.product-card  slidercard="" productname="{{__('e-commerce.pink_hand')}}" statusdetails="" statuscolor="" productimage="product/10.png" productrating="3.5" productprice="$65.00"/>
                        </div>
                        <div class="col">
                            <x-modules.e-commerce.widgets.product-card  slidercard="" productname="{{__('e-commerce.shoe')}}" statusdetails="" statuscolor="" productimage="product/02.png" productrating="3.9" productprice="$56.00"/>
                        </div>
